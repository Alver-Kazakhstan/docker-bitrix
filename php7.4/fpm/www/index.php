...
if (LANG == 'ru') {
	...
	$msg['title'] = 'Добро пожаловать<br>в Docker-контейнер для 1С-Битрикс!';
	$msg['desc'] =
		'Система оптимально сконфигурирована и готова к использованию<br>"1С-Битрикс: Управление сайтом", "1С-Битрикс: Энтерпрайз" и "1С-Битрикс24".<br>';
	$msg['setup'] = 'Установить';
	$msg['restore'] = 'Восстановить копию';
	$msg['crm_title'] = 'Бизнес работает в ';
} elseif (LANG == 'de') {
	$msg['hello'] = 'Willkommen!';
	$msg['title'] = 'Herzlich willkommen<br>bei der Docker-Container für Bitrix!';
	$msg['desc'] =
		'Das System ist für die Verwendung von<br>"Bitrix24" und "Bitrix Site Manager " optimal konfiguriert und einsatzbereit".<br>';
	$msg['setup'] = 'Installieren';
	$msg['restore'] = 'Aus dem Backup wiederherstellen';
	$msg['crm_title'] = 'Your company. United.';
} else {
	$msg['hello'] = 'Welcome!';
	$msg['title'] = 'Welcome to<br>Docker container for Bitrix!';
	$msg['desc'] =
		'System is optimally configured and is ready<br>to be used with "Bitrix Site Manager" and "Bitrix24".<br>';
	$msg['setup'] = 'Install';
	...
	<body>
		<style>
			...
			.content-container {
				...
				box-shadow: 0 4px 20px 0 rgba(6, 54, 70, 0.15);
			}
